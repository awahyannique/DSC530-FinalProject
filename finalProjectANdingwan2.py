...
# -*- coding: utf-8 -*-
"""
Created on Wed May 21 23:04:21 2020
...
sns.countplot(y = df.Nationality.head(500) ,palette="Set2") #Plot all the nations on Y Axis
...
sns.barplot(x4, y4, palette=sns.color_palette("RdBu"))
